...
public class moveAnimation extends Transition {
    ...
    protected void interpolate(double v) {
        ...
        if (moveRoad.size() == 0) {
            ...
            for (Units units1 : units) {
                ...
                if (Game.getMapInGame().getMap()[units1.getxLocation()][units1.getyLocation()].isHasKillerTale()) {
                    this.stop();
                    taleCheck();
    ...
    private void taleCheck() {
        ...
        MapMenu.moveAlert.setContentText("your units killed with tale");
    }
