    ...
    public void submit(MouseEvent mouseEvent) throws Exception {
        if(captchaAnswer.getText().equals("")||(first==null&&second==null&&third==null)){
            ...
            if(!captchaAnswer.getText().equals(path)){
                ...
                LoginSignupControl.createUser(LoginSignupMenu.username,LoginSignupMenu.password,LoginSignupMenu.emailAddress,LoginSignupMenu.nickname,LoginSignupMenu.slogan,captchaAnswer.getText());
